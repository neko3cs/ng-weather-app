...
@Component({
  ...
  template: `
    @if (current) {
      <div class="mt-4 p-6 rounded-xl bg-[var(--mat-sys-surface-container-low,#f5f5f5)]">
        <h3 class="mt-0 text-base font-medium text-[var(--mat-sys-on-surface-variant)] mb-4">現在の天気</h3>
        
        <div class="text-center my-4 mb-8">
          <div class="text-[4.5rem] font-light leading-none flex justify-center items-start text-[var(--mat-sys-on-surface)]">
        ...
        <div class="grid grid-cols-2 gap-4 mb-8">
          <div class="flex items-center gap-4 p-3 bg-[var(--mat-sys-surface,white)] rounded-lg shadow-sm">
            <mat-icon color="primary" class="!text-2xl !w-6 !h-6 opacity-80">opacity</mat-icon>
            <div class="flex flex-col">
              <span class="text-[0.75rem] text-[var(--mat-sys-on-surface-variant)] mb-0.5">湿度</span>
          ...
          <div class="flex items-center gap-4 p-3 bg-[var(--mat-sys-surface,white)] rounded-lg shadow-sm">
            ...
            <div class="flex flex-col">
              <span class="text-[0.75rem] text-[var(--mat-sys-on-surface-variant)] mb-0.5">降水量</span>
          ...
          <div class="flex items-center gap-4 p-3 bg-[var(--mat-sys-surface,white)] rounded-lg shadow-sm">
            ...
            <div class="flex flex-col">
              <span class="text-[0.75rem] text-[var(--mat-sys-on-surface-variant)] mb-0.5">積雪量</span>
          ...
          <div class="flex items-center gap-4 p-3 bg-[var(--mat-sys-surface,white)] rounded-lg shadow-sm">
            ...
            <div class="flex flex-col">
              <span class="text-[0.75rem] text-[var(--mat-sys-on-surface-variant)] mb-0.5">風速</span>
              <span class="font-semibold text-base">{{ current.windSpeed }}km/h</span>
            </div>
          </div>
        </div>

        <div class="flex justify-around pt-6 border-t border-[var(--mat-sys-outline-variant,#e0e0e0)] text-[0.95rem] text-[var(--mat-sys-on-surface-variant)]">
